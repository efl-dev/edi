...
#define IFPCFGEND }
   ...
   /* setup defaults */
   IFPCFG(0x0001);
   _edi_project_config->gui.width = 800;
   _edi_project_config->gui.height = 600;
   ...
   _edi_project_config->gui.show_width_marker = EINA_FALSE;
   ...
   _edi_project_config->gui.toolbar_text_visible = EINA_FALSE;
   IFPCFGEND;
